export const ru = {
  ...
  candidateForm: {
    ...
    subtitle: 'Пожалуйста, заполните все поля анкеты',
    tryAgain: 'Попробовать снова',
    submit: 'Отправить анкету',
    submitting: 'Сохранение...',
    goToTestInfo: 'Перейти к информации о тесте',
    ...
    errors: {
      ...
      unexpectedError: 'Произошла непредвиденная ошибка. Пожалуйста, повторите попытку позже.',
      missingEmployeeId: 'Не удалось определить ваш ID. Пожалуйста, обновите страницу и повторите попытку.',
      submissionError: 'Ошибка при отправке формы. Пожалуйста, проверьте введенную информацию и повторите попытку.',
      tokenAlreadyUsed: 'Этот токен доступа уже был использован. Если вы заполнили форму ранее, перейдите к информации о тесте. В противном случае, запросите новую ссылку.',
      ...
      telegramFormat: 'Telegram тег должен начинаться с @',
