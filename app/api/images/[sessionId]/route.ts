...
// GET /api/images/:sessionId - получить информацию об изображении
...
// DELETE /api/images/:sessionId - удалить изображение
...
// PATCH /api/images/:sessionId - обновить метаданные изображения
